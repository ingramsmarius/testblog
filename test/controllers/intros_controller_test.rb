...
class IntrosControllerTest < ActionController::TestCase
  ...
  test "should create intro" do
    assert_difference('Intro.count') do
      post :create, intro: { description: @intro.description, name: @intro.name, note: @intro.note, number: @intro.number }
    end
  ...
  test "should update intro" do
    patch :update, id: @intro, intro: { description: @intro.description, name: @intro.name, note: @intro.note, number: @intro.number }
    assert_redirected_to intro_path(assigns(:intro))
  end
